...
n_for_std_error = len(all_at.resids)
...
if csv == 'yes':
    ...
    # save as a csv file 
    # np.savetxt(f'{csv_filename}.csv', surv_prob_data, delimiter = ',', header=f'SP timeseries of sel {an}, 6 of ref {at_site}\n{cwd}')  
...
plt.scatter(sps, sp_mean, c=colour, marker=plot_marker )
