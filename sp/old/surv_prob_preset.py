...
for at_site in all_at.resids:
    ...
    if csv == 'yes':
        ...
        # save as a csv file 
        np.savetxt(f'{csv_filename}.csv', surv_prob_data, delimiter = ',', header=f'SP timeseries of sel {an}, 4 of ref {at_site}\n{cwd}')  
    else:
