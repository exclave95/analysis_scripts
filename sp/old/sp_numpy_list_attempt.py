...
if csv == 'yes':
    ...
    # save as a csv file 
    np.savetxt(f'{csv_filename}.csv', time_sp_data_to_save, delimiter = ',', header=f'SP timeseries of sel {an}, 6 of ref {at_site}\n{cwd}')  
...
plt.scatter(time_timeseries_list, sp_mean, c=colour, marker=plot_marker )
